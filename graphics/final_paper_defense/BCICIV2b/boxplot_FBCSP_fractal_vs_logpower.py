...
base_path = r"d:\dev\EEG-TCC\results\bciciv2b"
...
plt.ylabel("Acurácia")
plt.title("Boxplot das acurácias - BCICIV2b: FBCSP + Fractal vs FBCSP + LogPower")
plt.grid(axis="y", linestyle="--", alpha=0.7)
plt.tight_layout()

# Salvar figura na pasta graphics/scripts/final_paper_defense/BCICIV2b/results
