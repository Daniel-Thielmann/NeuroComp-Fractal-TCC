...
def test_fractal_classification_bciciv2a():
    ...
    for subject_id in range(1, 10):
        try:
            ...
            features = []
            for trial_idx in range(fractal_features.shape[0]):
                trial_feat = []
                for ch_idx in range(fractal_features.shape[1]):
                    comp = X_filtered[trial_idx, ch_idx, :]
                    fractal_dim = fractal_features[trial_idx, ch_idx]
